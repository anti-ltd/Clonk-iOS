...
/// blocks an extension's audio session otherwise). Without Full Access, Clink
...
public extension SoundPack {
    ...
    static let presets: [SoundPack] = [
        ...
        // Custom sample packs are temporarily disabled for shipment until their
        // curated audio files land in `Resources/Sounds/`. Restore the entries
        // below once the samples exist.
        // SoundPack(
