...
/// App-wide state for the Clonk container app. Owns the editable
...
final class AppModel {
    ...
    /// Whether "Clonk" appears in the user's enabled keyboards. Refreshed on
    ...
    private let keyboardBundleID = "ltd.anti.clonk.keyboard"
    private let emojiBundleID = "ltd.anti.clonk.emoji"
